...
public class MateriasController {
    ...
    public String saveMateriaModificada(@ModelAttribute("nuevaMateria") Materia materiaModificada, RedirectAttributes redirectAttributes) {
        System.out.println("Datos recibidos para modificar: " + materiaModificada); // Línea de depuración
        if (materiaModificada.getCodigo() == null) {
            System.out.println("Código es nulo, revisa el formulario.");
        }
